    ...
    <footer className='bg-white'>
      ...
      <div className='p-4 max-w-1000 mx-auto grid grid-cols-[1fr_170px_170px_170px] gap-8 max-md:gap-4 max-md:grid-cols-[1fr_1fr]'>
        ...
        <div className="p-2">
          ...
          <Link href='/sap-services' className='text-black mb-2 block transition-[transform] hover:text-primary  hover:translate-x-2'>Services</Link>
        ...
        <div className="p-2">
          ...
          <Link href='/industries/sap-oil-gas-solutions' className='text-black mb-2 block transition-[transform] hover:text-primary  hover:translate-x-2'>Oil and Gas</Link>
          <Link href='/industries/sap-commodity-management-metals-mining' className='text-black mb-2 block transition-[transform] hover:text-primary  hover:translate-x-2'>Metal and Mining</Link>
