...
export default function Home() {
  ...
  return (
    <>
              ...
              <SwiperSlide key={ind}>
                <div className="flex justify-center items-center flex-col w-full h-full p-4  relative bg-black">
                  <Image
                    ...
                    fill
                  />
                  <h2 className="max-w-[800px] text-[44px] max-md:text-3xl font-bold leading-tight mb-5 text-transparent bg-clip-text bg-gradient-to-t via-white from-[#f3bfff] to-white">
                    {slide.heading}
                  </h2>
                  <p className="max-w-[650px] leading-tight text-white mb-4 max-md:text-base">
                    {slide.para}
                  </p>
                  <div className="flex gap-4 max-[500px]:flex-col">
                    <Link passHref href={slide.link}>
                      <button className="w-36 px-5 py-1 rounded-md text-white bg-gradient-to-r from-primary to-secondary border border-transparent">
                        Get Started
                      </button>
                    </Link>
                    <Link passHref href={slide.cta}>
                      <button className="w-36 px-5 py-1 rounded-md text-white bg-transparent border">
                        Join Us
                      </button>
                    </Link>
                  </div>
      ...
      <section
        data-aos="fade-up"
        className="w-full p-4 md:py-8 bg-gradient-to-r from-secondary to-third text-white"
      >
        <div className="max-w-1200 mx-auto">
          <h2 className="text-center md:text-4xl text-3xl mb-4">
            Stats at Glance
          </h2>
          <ScrollTrigger
            onEnter={() => setStartAnimation(true)}
            onExit={() => setStartAnimation(false)}
          >
            <div className="grid grid-cols-4 gap-4 max-md:grid-cols-2">
              <div className="text-center p-2">
                <p className="text-3xl font-semibold">
                  <CountUp isCounting={startAnimation} start={1} end={30} />+
                </p>
                <p>Clients across Globe</p>
              </div>
              <div className="text-center p-2">
                <p className="text-3xl font-semibold">
                  <CountUp isCounting={startAnimation} start={1} end={50} />+
                </p>
                <p>Number of Employees</p>
              </div>
              <div className="text-center p-2">
                <p className="text-3xl font-semibold">
                  <CountUp isCounting={startAnimation} start={1} end={10} />+
                </p>
                <p>Global Projects</p>
              </div>
              <div className="text-center p-2">
                <p className="text-3xl font-semibold">
                  <CountUp isCounting={startAnimation} start={1} end={18} />+
                </p>
        ...
        <div className="max-w-1200 mx-auto flex gap-10 flex-wrap ">
          <div className="flex-1">
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="300"
              className="text-black mb-6 opacity-70"
            >
              Empowering business organisations to unlock their full potential
            ...
            <div className="grid grid-cols-2 max-[600px]:grid-cols-1 w-full gap-4">
              <div
                data-aos="flip-left"
                className="flex items-center p-2 px-5 rounded-full border border-black/20 text-secondary"
              >
                <Image
                  alt="check_with_circle_svg"
                  src={require('../assets/images/icons/check-with-circle.svg')}
      ...
      <section className="w-full p-4 md:py-8 max-w-1200 mx-auto ">
        <div className="flex items-center flex-col mb-10 max-md:mb-5 text-center">
          ...
          >
            Our industry-led SAP services are tailored to meet your business
            needs.
          </p>
        </div>
        {/* View for Desktop */}
              ...
              <>
                ...
                >
                  <Image
                    ...
                    src={industry.image}
                    priority
                    className="object-cover w-full h-full absolute top-0 left-0 z-[85] rounded-md group-hover:scale-[1.1] transition-[transform]"
                  />
                  <div className="z-[87] select-none">
                    <h3 className="text-white font-semibold text-2xl md:text-3xl mb-2">
                      {industry.name}
                    </h3>
                    <p className="text-white/50 mb-2 min-h-[96px]">
                      {industry.description}
                    </p>
                    <Link
                      href={industry.link}
                      className="text-[#FFAAE3] opacity-60 hover:opacity-100"
                    >
                      Learn More &gt;
                    </Link>
                  </div>
        ...
        <div data-aos="fade-up" className="md:hidden">
          <Swiper
            ...
            loop={true}
            modules={[Pagination, Autoplay]}
            className="sideSwiper rounded-md"
            pagination={{ clickable: true }}
      ...
      <section className="w-full p-4 md:py-8 max-w-1200 mx-auto ">
        <div className="flex items-center flex-col mb-10 max-md:mb-5 text-center">
          ...
          <p
            data-aos="flip-left"
            data-aos-delay="100"
            className="text-black opacity-70 text-center max-w-800"
          >
            SAP Implementation: Our expert team ensures a seamless SAP
            implementation process, customizing the system to fit your business
            requirements and enabling you to unlock the full potential of
            SAP&apos;s capabilities.
          </p>
        </div>
        {/* View for Desktop */}
      ...
      <section className="w-full p-4 md:py-8 max-w-1200 mx-auto ">
        <div className="flex items-center flex-col mb-10 max-md:mb-5 text-center">
          ...
          <p
            ...
            className="text-black opacity-70 text-center max-w-800"
          >
            We pride ourselves in providing industry-led SAP services customized
            to your unique business needs. Our team of experienced SAP
            professionals is dedicated to delivering exceptional results and
            unparalleled customer satisfaction, making us the ideal partner for
            businesses looking to achieve their respective goals and stay ahead
            of the competition.
          </p>
        </div>
        {/* View for Desktop */}
          ...
          {whyChooseUsData.map(({ name, description, image }, ind) => {
            ...
            return (
              <div
                ...
                data-aos="fade-up"
                data-aos-delay={ind * 100}
                className={`${even ? 'bg-white border-primary/10' : 'bg-gradient-to-br from-primary to-secondary border-transparent'} rounded-md border-2 aspect-[3/4] p-4 flex hover:shadow-card overflow-clip`}
              >
                <div
                  className={`select-none ${even ? 'text-black' : 'text-white'}`}
                >
                  <div
                    className={`${!even ? 'bg-white' : 'bg-gradient-to-br from-primary to-secondary '} rounded-md aspect-[1/1] w-20 p-3 flex mb-8`}
                  >
      ...
      <section className="w-full p-4 md:py-8 max-w-1200 mx-auto ">
        <div className="flex items-center flex-col mb-10 max-md:mb-5 text-center">
          ...
          <p
            data-aos="flip-left"
            data-aos-delay="100"
            className="text-black opacity-70 text-center"
          >
            Our partnerships with industry leaders enable us to provide most
            innovative and cutting-edge SAP solutions
          </p>
        </div>
          ...
          {partnersDetails.map(({ name, image }, ind) => {
            return (
              <div
                ...
                data-aos="fade-up"
                data-aos-delay={ind * 100}
                className="bg-white p-4 max-x-sm:w-[130px] w-[170px] flex justify-center"
              >
                <Image
                  src={image}
                  alt={name}
      ...
      <section className="w-full p-4 md:py-8 bg-gradient-to-r from-primary to-third text-white relative">
        <Image
          src={mapBg}
          alt="map-with-flag"
          className="absolute top-0 left-0 w-full h-full md:object-contain object-cover md:p-8 max-md:py-8"
        />
        <div className="max-w-1200 mx-auto">
          <div className="flex items-center flex-col mb-10 max-md:mb-5 text-center text-white">
            <p data-aos="flip-left" className="uppercase mb-2 font-medium">
              Clients
            </p>
            <h2
              data-aos="flip-up"
              className="md:text-4xl text-3xl font-semibold mb-2"
            >
              Partnering with Industry Leaders
            </h2>
            <p data-aos="flip-left" className="opacity-70 text-center">
              Our partnerships with industry leaders enable us to provide most
              innovative and cutting-edge SAP solutions
            </p>
          </div>
          <div className="flex justify-center items-center gap-6 mb-4">
            <div className="max-w-[750px] w-full">
              <Swiper
                ...
                spaceBetween={50}
                fadeEffect={true}
                className="swiperReview rounded-md"
                pagination={{ clickable: true }}
                      ...
                      <div className="grid review:grid-cols-[200px_1fr] max-review:grid-rows-[225px_1fr] rounded-md">
                        <div>
                          <Image
                            ...
                            alt={data.name}
                            width={250}
                            className="w-full h-full review:object-cover max-review:object-cover review:rounded-l-lg max-review:rounded-t-lg "
                          />
                        </div>
                        <div className="bg-white p-4 text-black text-left text-base review:rounded-r-lg max-review:rounded-b-lg">
                          <p className="mb-4 line-clamp-5 h-[120px]">
                            {data.review}
                          </p>
      ...
      <section className="w-full p-4 md:py-8 bg-grey">
        <div className="max-w-1200 mx-auto flex gap-4 flex-wrap ">
          <div className="md:flex-1">
            ...
            >
              We provide local support and expertise to our clients, regardless
              of location, ensuring they receive the best possible service and
              results. So, why wait? Join us today for unique SAP solutions.
            </p>
          </div>
          <div
            data-aos="zoom-in"
            data-aos-delay={200}
            className="flex md:flex-1 max-md:text-center max-md:w-full max-md:justify-center"
          >
            <Image
              src={mapWithFlag}
              width={400}
