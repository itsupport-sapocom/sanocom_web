...
export default function MetalMining() {
    ...
    const faqSchema = {
        ...
        "@type": "FAQPage",
        "mainEntity": metalMiningFAQs.map(f => ({
            "@type": "Question",
            "name": f.question,
    ...
    const serviceSchema = {
        ...
        "provider": { "@type": "Organization", "name": "Sapocom Global", "url": "https://www.sapocomglobal.com" },
        "areaServed": [
    ...
    return (
        <>
            <SetHeaders
                title='SAP CTRM & Commodity Management for Metals | Sapocom Global'
            ...
            <HeaderBanner
                heading='SAP Commodity Management for Metals and Mining'
                para='Ignite the Future of Metal and Mining with SAP CTRM: Unleash Enhanced Business Processes and Propel Productivity towards Sustainable Growth!'
                bgImg={bgBanner}
            />
            ...
            <IndustryFeatures
                ...
                description="The metal and mining industry faces a multitude of challenges that affect its operations, profitability, and sustainability."
