...
const data = {
  ...
  RECRUITMENT_EMAIL: "sanocom.recruitment@sanocomglobal.com",
};
...
export default async function sendMail(reciever) {
  try {
    ...
    await transporter.sendMail({
      ...
      subject: `Sanocom Form Submitted Successfully!`, // Subject line
      html: `<html>
      <head>
        <style>
          /* CSS styles */
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Sanocom Form Submitted Successfully</h1>
          </div>
          <div class="content">
            <p>Thank you for your Email. We will get back to you as soon as possible. If you have any queries or concerns, please contact us at <a href="mailto:websitequery@sanocomglobal.com">websitequery@sanocomglobal.com</a>.</p>
            ...
            <p>Any views expressed in this message are those of the individual sender, except where the sender specifies and with authority, states them to be the views of the Sanocom Technologies</p>
          </div>
          <div class="footer">
