...
export const MONGODB_URL = "mongodb+srv://sanocomwebsiteadm:sanocom123@sanocomwebsite.saidz2h.mongodb.net/?retryWrites=true&w=majority";
...
export const navTabs = [
  ...
  },
  {
    ...
    subTabs: [
      {
        name: "Oil and Gas",
        link: "/sap-oil-gas-solutions",
      },
      {
        name: "Metal and Mining",
        link: "/sap-commodity-management-metals-mining",
      },
      {
        name: "Agriculture",
        link: "/agriculture",
...
export const industryDetails = [
  {
    ...
    link: "/industries/sap-oil-gas-solutions",
    image: industryOil,
  },
  {
    name: "Metal & Mining",
    ...
    link: "/industries/sap-commodity-management-metals-mining",
...
export const whyChooseUsData = [
  {
    ...
    description:
      "With over 9+ years of experience, we are a dedicated pure-play SAP firm providing exceptional services to our clients. Our commitment and consistency have earned us the reputation as the premier Consulting Partner for leading big four consulting firms.",
    image: handshakeSvg,
  },
  {
